        ...
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[1fr_420px] lg:items-center">
          <Motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }}>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              {['4, 8 lub 12 butelek', 'do -40% w największej paczce', 'dostawa pod drzwi'].map((item) => (
      ...
      <section className="px-6 py-20">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 flex flex-wrap items-end justify-between gap-6">
            ...
            <Link to="/#pakiety" className="inline-flex items-center gap-2 rounded-full px-5 py-2.5 text-[13px] font-medium no-underline bg-fg text-bg">
