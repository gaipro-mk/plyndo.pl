...
async function run() {
  console.log('🚀 Logowanie z użyciem kodu 2FA i wstrzyknięcie skryptu...');
  ...
  await page.goto('https://sklep562393.shoparena.pl/admin/auth/mail-otp', { waitUntil: 'networkidle' });
