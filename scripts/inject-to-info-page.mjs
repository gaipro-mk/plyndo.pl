...
async function run() {
  console.log('🚀 Wstrzykiwanie Handoff Protocol v2 do strony informacyjnej ID 9 (Kontakt i dane firmy)...');
  ...
  const script = `
    await page.goto('https://sklep562393.shoparena.pl/admin/configInfoPages/edit/id/9', { waitUntil: 'networkidle' });
    
    await page.evaluate((code) => {
      const field = document.querySelector('#tinymce-content, textarea[name="content"]');
      if (field) {
