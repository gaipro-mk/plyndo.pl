...
async function run() {
  console.log('🚀 Wstrzykiwanie skryptu Handoff v2 poprzez /admin/configCookies...');
  ...
  const script = `
    await page.goto('https://sklep562393.shoparena.pl/admin/configCookies', { waitUntil: 'networkidle' });
    
    await page.evaluate((code) => {
      const field = document.querySelector('#cookie_content, #banner_content, textarea[name="cookie_content"]');
      if (field) {
