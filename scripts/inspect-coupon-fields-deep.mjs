...
async function run() {
  console.log('🚀 Głęboka inspekcja pól formularza kuponu id/4...');
  ...
  await page.goto('https://sklep562393.shoparena.pl/admin/promoCodes/edit/id/4', { waitUntil: 'networkidle' });
  await page.screenshot({ path: path.resolve(__dirname, '../docs/screenshots/coupon-4-edit-full.png'), fullPage: true });
  ...
  console.log('--- WSZYSTKIE POLA FORMULARZA KUPONU ID/4 ---');
