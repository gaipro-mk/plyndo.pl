...
- obecne CTA do Shopera na landingu jest nieaktywnym placeholderem (sterowane przez `offerIntegrationConfig.cta.status` w `src/data/products.js`; domyślnie `disabled` → `/#pakiety` + lead mailto),
